...
export const FALLBACK_COMPANY: Company = {
  name: 'Clothing',
  tagline: 'Wardrobe essentials with a point of view',
  description: 'Shop curated apparel, accessories, and seasonal drops — boutique polish, streetwear edge, or sustainable fibres in every collection.',
  logoUrl: null,
  heroImageUrl: null,
  ogImageUrl: null,
  brandColor: null,
