...
import { Shirt, Sparkles, Recycle, Heart, TrendingUp, Zap, Link2, Package } from 'lucide-react'
        ...
        <div className="container-wide">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-on-dark-muted">
              Curated apparel and accessories — boutique polish, streetwear edge, or sustainable fibres.
            </p>
          </div>
        </div>
      </section>
          ...
          {aboutArticle ? (
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-text-light leading-relaxed mb-6">
                {companyName} edits each season around fit, fabric hand, and longevity — fewer one-off
                trends, more pieces you reach for every week.
              </p>
              <p className="text-lg text-text-light leading-relaxed">
                From elevated basics to statement layers, we aim for clear sizing guidance, honest care
                instructions, and photography that shows drape and texture — not just flat lays.
              </p>
            </div>
          )}
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 my-8">
              ...
              <div className="card p-6 border-l-4 border-modern-primary">
                ...
                <p className="text-text-muted text-sm">
                  ...
                  competitive. Pricing is transparent across wardrobe staples, seasonal edits, and accessories.
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 my-8">
            <AnimatedCard className="card-vintage p-6 hover:shadow-md transition-shadow duration-300">
              <div className="w-12 h-12 bg-vintage-primary/10 rounded-lg flex items-center justify-center mb-4">
                <Shirt className="w-6 h-6 text-vintage-primary" />
              </div>
              <h3 className="font-semibold text-text mb-2">Fit &amp; fabrication</h3>
              <p className="text-text-muted text-sm">
                Construction details matter: seams, linings, and fabric weight should match how a piece is meant to feel.
              </p>
            </AnimatedCard>
            <AnimatedCard className="card p-6 hover:shadow-md transition-shadow duration-300">
              ...
              <h3 className="font-semibold text-text mb-2">Merchandising clarity</h3>
              <p className="text-text-muted text-sm">
                Colour names, fibre content, and model context help customers choose confidently online.
              </p>
            </AnimatedCard>
            <AnimatedCard className="card p-6 hover:shadow-md transition-shadow duration-300">
              <div className="w-12 h-12 bg-vintage-accent/10 rounded-lg flex items-center justify-center mb-4">
                <Recycle className="w-6 h-6 text-vintage-accent" />
              </div>
              <h3 className="font-semibold text-text mb-2">Lower-impact options</h3>
              <p className="text-text-muted text-sm">
                When we carry organic, recycled, or low-water fibres, we say so plainly — no greenwashing.
              </p>
            </AnimatedCard>
            <AnimatedCard className="card p-6 hover:shadow-md transition-shadow duration-300">
              ...
              <h3 className="font-semibold text-text mb-2">Service-minded</h3>
              <p className="text-text-muted text-sm">
                Exchanges and sizing questions deserve fast, human answers — especially for first-time customers.
              </p>
            </AnimatedCard>
          </div>
          <h2 className="text-2xl font-bold font-playfair text-text mt-12 mb-6">Our Promise</h2>
          <p className="text-text-light leading-relaxed mb-6">
            When you shop with {companyName}, you&apos;re not just buying a garment — you&apos;re
            choosing pieces meant to move with real life.
          </p>
          <p className="text-text-light leading-relaxed">
            Every item should be honestly described, carefully inspected, and shipped so it arrives
            ready to wear — not ready for a return.
          </p>
        </div>
      </AnimatedSection>
        ...
        <AnimatedSection id="examples" className="py-16 bg-vintage-background">
          <div className="container-wide">
            ...
            <p className="text-text-muted mb-8 max-w-2xl">
              A sample of apparel and accessories from our rails.
            </p>
      ...
      <section className="py-16 bg-modern-primary text-white">
        <div className="container-wide text-center">
          ...
          <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">
            Shop new arrivals, wardrobe foundations, and seasonal edits.
          </p>
